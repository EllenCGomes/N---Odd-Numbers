...
EXERCISE DESCRIPTION: Write a program that receives a positive integer and prints the "n" first natural odd numbers.
...
DESCRIÇÃO: Escreva um programa que receba um número inteiro positivo e imprima os "n" primeiros números ímpares naturais.
